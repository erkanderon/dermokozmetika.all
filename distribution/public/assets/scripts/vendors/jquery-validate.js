...
$.extend( $.validator, {
	...
	messages: {
		...
		max: $.validator.format( "Lütfen {0} değerinden küçük veya {0} değerine eşit bir değer girin." ),
		min: $.validator.format( "Lütfen {0} değerinden büyük veya {0} değerine eşit bir değer girin." ),
